# Based on YOLO deep learning and the large models of Qianwen and DeepSeek, bearing defects

## Body

Based on YOLO deep learning and the big model of Qianwen and DeepSeek, bearing defects
